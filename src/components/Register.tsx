...
export const Register: React.FC = () => {
    ...
    return (
        <div className={clsx(
            ...
            {/* Brand Header */}
            <Link to="/" className="absolute top-8 left-8 flex items-center gap-3 animate-in fade-in slide-in-from-top-4 duration-700 hover:opacity-80 transition-opacity">
